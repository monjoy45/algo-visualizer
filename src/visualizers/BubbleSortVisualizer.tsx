...
import { bubbleSort, bubbleSortGen } from "../algorithms/sorting/bubbleSort";
...
export function BubbleSortVisualizer() {
  const [input, setInput] = useState<number[]>(() => randomArray(10, 5, 95, 1));
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px]">
      <div className="min-w-0">
        ...
        />
        <PseudocodePanel lines={bubbleSort.pseudocode} activeId={currentStepId} />

...
import { dfs, dfsGen } from "../algorithms/graphs/dfs";
import type { GraphInput } from "../algorithms/graphs/bfs";
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px]">
      <div className="min-w-0">
        <GraphRenderer state={state} structureLabel="stack" />
        <PlaybackControls
          step={playback.step}
        ...
        />
        <PseudocodePanel lines={dfs.pseudocode} activeId={currentStepId} />
      </div>

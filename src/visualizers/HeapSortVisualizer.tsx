...
import { heapSort, heapSortGen } from "../algorithms/sorting/heapSort";
...
export function HeapSortVisualizer() {
  const [input, setInput] = useState<number[]>(() => randomArray(10, 5, 95, 5));
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px]">
      <div className="min-w-0">
        ...
        />
        <PseudocodePanel lines={heapSort.pseudocode} activeId={currentStepId} />

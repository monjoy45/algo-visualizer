...
import { insertionSort, insertionSortGen } from "../algorithms/sorting/insertionSort";
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px]">
      <div className="min-w-0">
        ...
        />
        <PseudocodePanel lines={insertionSort.pseudocode} activeId={currentStepId} />
        <div className="flex items-center gap-2 border-t border-[var(--ink-700)] px-4 py-3">
          <button
            onClick={() => setInput(randomArray(10, 5, 95))}

...
import { selectionSort, selectionSortGen } from "../algorithms/sorting/selectionSort";
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px]">
      <div className="min-w-0">
        ...
        />
        <PseudocodePanel lines={selectionSort.pseudocode} activeId={currentStepId} />
